...
class BaseTrainer(object):
    ...
    def _print_reports(self):
        ...
        temp.to_csv(os.path.join(self.args.record_dir, self.args.dataset_name+'_reports_semantic'+'.csv'))

        # temp_train = pd.DataFrame([])
        #
        # temp_train['res'] = self.train_res
        # temp_train['gts'] = self.train_gts
        #
        # temp_train.to_csv(os.path.join(self.args.record_dir, self.args.dataset_name + '_train_reports_semantic' + '.csv'))
    ...
    def _train_epoch(self, epoch):
        ...
        for batch_idx, (images_id, images, reports_ids, reports_masks) in enumerate(tqdm(self.train_dataloader)):
            ...
            images, reports_ids, reports_masks = images.to(self.device), reports_ids.to(self.device), reports_masks.to(
                self.device)
            output = self.model(images, images_id,reports_ids, mode='train')
        ...
        #         output = self.model(images, images_id, mode='sample')
        ...
        return log, test_res, test_gts#, train_res, train_gts
